...
def main():
     ...
     types = ['world', 'india', 'sports', 'entertainment', 'business']
     ...
     for link_type in types:
            ...
            while offset < 200:
                ...
                article_urls, length = get_all_articles("http://www.univarta.com/news", link_type, offset)


                offset = length + offset

                for article_url in article_urls:
                    comp_url = "http://www.univarta.com" + article_url
                    # print (comp_url)
